...
This project contains all the source files that the course instructor will be writing in class during the 2021 August-Decembar semester.
...
2. Clone this repository. Type at the terminal:
    ...
    git clone https://github.com/ariel-ortiz/202113-tc2006.1.git tc2006
